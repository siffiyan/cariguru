    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="#" style="background: #E51453; color: #fff; border-radius: 4px; margin: 0 15px; padding: 10px 25px;">Masuk</a></li>
        </ul>
      </nav><!-- .nav-menu -->
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="card" style="width: 18rem;">
                <img src="{{asset('logo/portfolio/portfolio-2.jpg')}}" class="card-img-top" alt="...">
                <div class="card-body">
                    <span class="badge badge-danger">Active</span>
                    <br>
                    <small>12 Juni 2020</small>
